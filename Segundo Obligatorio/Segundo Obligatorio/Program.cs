    ...
    class Program
    {
        ...
        public static void MantenimientoClientes(ArrayList ListaClientes)
        {
            ...
            while (ejecutando)
            {
                ...
                Console.Write("Ingrese el número de cedula o presione 'S' para voler al menú principal: ");
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (BuscoCliente(cedula, ListaClientes) == null) ;
                        {
                            ...
                            Console.Write("El cliente no se encuentra en la base de datos. ¿Desea agregarlo <S/N>? :");
                            string opciondos = Console.ReadLine();
                            if (opciondos == "S" || opciondos == "s")
                            {
                                AgregoCliente(cedula, ListaClientes);
                            }
                            else
                            {
                                ejecutando = false;
        ...
        public static void AgregoCliente(int cedula, ArrayList ListaClientes)
        {
